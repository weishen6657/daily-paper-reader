...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-17 20:51:30 UTC<br>状态：成功</p>
</section>
...
<p>今日精读2篇、速读2篇，重点聚焦网格物理模拟与降阶建模。最值得关注HI-MeshGraphNets的层级多尺度图网络，以及降阶模型在反演状态估计中的应用。建议普通读者优先浏览这两篇精读论文的摘要与图表，快速把握方法核心。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="HI-MeshGraphNets: Efficient and Accurate Mesh-based Physics Learning with Hierarchical Multi-scale Graph Neural Networks">HI-MeshGraphNets: Efficient and Accurate Mesh-based Physics Learning with Hierarchical Multi-scale Graph Neural Networks</span></li><li><span class="dpr-home-dashboard-paper-title" title="Reduced Order Modeling and Applications to Inverse State Estimation">Reduced Order Modeling and Applications to Inverse State Estimation</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="XGBoost &quot;is all you need&quot;: the case of forecasting transmitted heat energy in District Heating Systems">XGBoost &quot;is all you need&quot;: the case of forecasting transmitted heat energy in District Heating Systems</span></li><li><span class="dpr-home-dashboard-paper-title" title="A Local Sinkhorn Framework for Conditional Distribution Reconstruction of Multidimensional Random Fields">A Local Sinkhorn Framework for Conditional Distribution Reconstruction of Multidimensional Random Fields</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">ag <strong>2</strong></span></div>
</section>
</div>
