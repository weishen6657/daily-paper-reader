...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-31 19:12:18 UTC<br>状态：成功</p>
</section>
...
<p>今日完成4篇论文速读，无精读，整体状态成功。最值得关注的方向是物理算子学习中的高斯溅射表示与超图自适应小波算子，另有共形不确定性量化方法值得留意。建议普通读者优先浏览这三篇的引言与结论，或补充阅读剩余一篇以完整把握当日进展。</p>
  </div>
</section>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Physics-Integrated Operator Learning via Gaussian Splatting Representations">Physics-Integrated Operator Learning via Gaussian Splatting Representations</span></li><li><span class="dpr-home-dashboard-paper-title" title="Beyond Pairwise Graphs in Science: Hypergraph Adaptive Wavelet Operators for Parametric PDEs">Beyond Pairwise Graphs in Science: Hypergraph Adaptive Wavelet Operators for Parametric PDEs</span></li><li><span class="dpr-home-dashboard-paper-title" title="Conformal Uncertainty Quantification Guarantees for Neural Operators">Conformal Uncertainty Quantification Guarantees for Neural Operators</span></li></ul>
  </div>
